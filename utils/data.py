...
def generate_vocab(train_file, validation_file, test_file, stemming_arabic=False, new_preprocess=False, bpe_lang_list=None, bpe_vocab=5000, bpe_emb_size=300, bpe_cache=""):
    word2id, id2word = {}, {}
    char2id, id2char = {}, {}
...
def prepare_dataset(train_file, valid_file, test_file, batch_size, eval_batch_size, train_valid=False, bpe_lang_list=None, bpe_vocab=5000, bpe_emb_size=300, bpe_cache=""):
    if train_valid:
        all_inputs, all_targets, all_raw_inputs, all_raw_seqs = read_data(train_file)
    ...
    bpe_lang_list=bpe_lang_list, bpe_vocab=bpe_vocab, bpe_emb_size=bpe_emb_size, bpe_cache=bpe_cache)
